...
global.channelLink = "https://whatsapp.com/channel/0029VbCMgIvFnSzF359e6t2T";
global.ytch = "𝕯𝕏ꜰ(HUSNAIN🇵🇰)";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbCMgIvFnSzF359e6t2T'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/CfgKXqdl2Z34yiVii6bHA8`
                }, { quoted: message });
                return;
            }
        }
